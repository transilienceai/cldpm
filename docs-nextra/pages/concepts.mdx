...
- Can be a directory (e.g., `shared/skills/logging/`) or a single file (e.g., `shared/skills/quick-tip.md`)
...
- Can be a directory (e.g., `.claude/agents/coordinator/`) or a single file (e.g., `.claude/agents/coordinator.md`)
...
├── my-local-skill/  (directory component, committed)
├── my-note.md       (file component, committed)
