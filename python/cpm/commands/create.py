...
def skill(
    ...
    Examples:
      ...
      cpm create skill advanced-review --skills base-review,utils
      cpm create skill full-check -s lint-check -h pre-commit -r security
    """
...
def agent(
    ...
    Examples:
      ...
      cpm create agent security-audit --skills vuln-scan,code-review
      cpm create agent full-audit -s scan -a reviewer -h pre-commit -r security
    """
...
def hook(
    ...
    Examples:
      ...
      cpm create hook pre-commit -d "Pre-commit validation"
...
def _create_component(
    ...
    component_path = repo_root / cpm_config.shared_dir / component_type / name
