"""Implementation of cpm clone command."""
...
from ..core.config import load_cpm_config, load_project_config
...
def clone(
    ...
    if include_shared:
        ...
        # Also copy cpm.json for reference
        shutil.copy2(repo_root / "cpm.json", target_path / "cpm.json")
